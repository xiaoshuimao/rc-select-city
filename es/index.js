...
var SelectCity = /** @class */ (function (_super) {
    ...
    function SelectCity(props) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetchFn(addressApi, { type: type ? type : 1 })];
                    case 1:
                        data = _c.sent();
                        if (data.status === 0) {
                            _b = parseAddress(data.data, deepMap.length - 1), addressMap = _b.addressMap, addressMapSearch = _b.addressMapSearch;
                            selectValLength = selectVal.length;
                            tempSelectName = selectValLength > 0 ? /* 根据默认值解析中文名称 */ parseAddressName(selectVal, addressMap) : [];
                            this.setState({
        ...
        if (address) {
            var data = parseAddress(address, deepMap.length - 1);
    ...
    SelectCity.prototype.onChange = function (e) {
         ...
         * 节流阀
         */
        throttle(function () { return __awaiter(_this, void 0, void 0, function () {
            var searchResult;
            return __generator(this, function (_a) {
                ...
                if (!Object.prototype.hasOwnProperty.call(this._cache, searchName)) {
                    searchResult = matchSearch(searchName, this.state.addressMapSearch, this.state.addressMap, this.props.params.deepMap);

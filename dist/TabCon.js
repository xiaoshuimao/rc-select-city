    ...
    TabCon.prototype.getItems = function () {
        ...
        var cityItem = function (val) {
            ...
            for (var key in val) {
                ...
                items.push(React.createElement(CityItem, __assign({ key: ++globalkey, id: id_1, val: val, active: active }, _this.props)));
            }
            return items;
        };
        /* 如果是第一级不同的处理 */
        ...
        var items = [];
        for (var key in data) {
            items.push(React.createElement("div", { className: "area-item-group", key: ++globalkey },
                (key !== '' && key !== 'null' && key !== 'undefined') && React.createElement("span", { className: "area-item" }, key),
                React.createElement("div", { className: "city-item-group" }, cityItem(data[key]))));
        }
        return (React.createElement("div", { className: "citys-wrap" }, items));
        var e_1, _d;
    };
...
var CityItem = /** @class */ (function (_super) {
    ...
    CityItem.prototype.render = function () {
        ...
        return (React.createElement("span", { className: className, "data-id": id, onClick: function (e) { return _this.handleClick(); } },
            " ",
            name,
            " "));
    };

...
var PostionContainer = /** @class */ (function (_super) {
            ...
            return [
                {
                    ...
                    render: function (text, record) {
                        ...
                        for (var key in record) {
                            var data = record[key];
                            arr.push(react_1.default.createElement("span", { key: data.value },
                                _this.highlight(data),
                                " "));
                        }
                        return react_1.default.createElement("div", null, arr.map(function (value, index) {
    ...
    PostionContainer.prototype.highlightReplace = function (data, matchQ) {
        ...
        return newData.split('*&*').map(function (value) {
            if (value === matchQ) {
                return react_1.default.createElement("span", { style: { color: '#ff6600' }, key: value }, value);
            }
            return value;
        });
    };
    ...
    PostionContainer.prototype.render = function () {
        ...
        return react_dom_1.default.createPortal(react_1.default.createElement("div", { className: className, style: style, onClick: function (e) { return _this.handClick(e); } }, searching ?
            react_1.default.createElement(antd_1.Table, __assign({}, this.tableProps()))
            :
                react_1.default.createElement("div", null,
                    react_1.default.createElement(Tab_1.default, __assign({}, this.props)),
                    react_1.default.createElement(TabCon_1.default, __assign({}, this.tabConProps())))), this._container);
    };
    return PostionContainer;
}(react_1.Component));
exports.default = PostionContainer;

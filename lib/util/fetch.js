...
var encodechar_1 = require("./encodechar");
var index_1 = require("antd/lib/message/index");
/**
 * 带有timeout的_fetch
 * @param fetchPromise
 ...
 */
exports.fetchFn = function (url, data, option) {
    if (url === void 0) { url = ''; }
    var json = {
        method: 'post',
        headers: {
        ...
        timeout: 30000,
        body: encodechar_1.enCodeChar(data),
        credentials: 'include',
    };
    if (option) {
    ...
    return new Promise(function (resolve, reject) {
        _fetch(fetch(url, json), json.timeout)
            ...
            if (Number(data.status) !== 0) {
                index_1.default.error(data.error || data.msg || data.errmsg || '请求失败');
            }
            resolve(data);
        })
